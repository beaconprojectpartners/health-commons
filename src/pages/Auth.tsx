                  ...
                  <form onSubmit={handleSignUp} className="space-y-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <label htmlFor="terms" className="text-xs text-muted-foreground leading-tight">
                        I agree to use this data only for research purposes. Data is anonymized, not for re-identification or commercial resale. Attribution to DxCommons is encouraged.
                      </label>
                    </div>
